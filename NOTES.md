...
- [x] Source `.serverenv` for dev mode only
  - Note: Sourcing if present. Should not be present for production.
- [ ] Styling
- [ ] Service worker for offline
  - [x] Precache, background sync
  - [ ] Make spreadsheetId, entries cacheable and reusable
